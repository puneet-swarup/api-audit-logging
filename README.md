...
A Spring Boot 3.4+ audit logging starter for capturing inbound and outbound API traffic with very
...
```gradle
dependencies {
    implementation "com.api.audit:api-audit-logging-starter:2.0.0"
}
```
...
implementation "com.api.audit:api-audit-logging-storage-jpa:2.0.0"
```
...
```gradle
implementation "com.api.audit:api-audit-logging-autoconfigure:2.0.0"
implementation "com.api.audit:api-audit-logging-storage-jdbc:2.0.0"
```
...
```gradle
implementation "com.api.audit:api-audit-logging-autoconfigure:2.0.0"
implementation "com.api.audit:api-audit-logging-storage-memory:2.0.0"
```
